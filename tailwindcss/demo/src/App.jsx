  ...
  return (
    <div className='max-w-xs rounded-lg overflow-hidden bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto'>
      ...
      <div className="relative">
        <img src="https://img1.baidu.com/it/u=400864332,910444934&fm=253&fmt=auto&app=138&f=JPEG?w=514&h=500"
          alt="" className='w-full h-64 object-cover' />
        <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">
          New
        </span>
        <button className="absolute top-2 right-2 text-grey-500 hover:text-red-500 transition-colors">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center mt">
          ...
          <span className="ml-1 text-xs text-grey-500">4.4 (128 reviews)</span>
        </div>
